...
public class BookConverter implements Converter<Book, BookDto> {
        ...
        public BookDto convert(@NonNull Book book) {
                ...
                return BookDto.builder()
                                ...
                                .cover("/images/" + (book.getCoverImage() != null ? book.getCoverImage().getId()
                                                : "default"))
        ...
        public BookDto convert(@NonNull Book book, java.util.Set<java.util.UUID> favoriteBookIds) {
                BookDto dto = convert(book);
                if (favoriteBookIds != null && favoriteBookIds.contains(book.getId())) {
        ...
        public Book convert(BookDto bookDto) {
                ...
                builder
                                ...
                                .language(bookDto.getInformation() != null ? bookDto.getInformation().getLanguage()
                                                : null)
                                .delivery(bookDto.getInformation() != null ? bookDto.getInformation().getDelivery()
                                                : null)
